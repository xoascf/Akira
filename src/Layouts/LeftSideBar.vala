...
public class Akira.Layouts.LeftSideBar : Gtk.Grid {
    ...
    construct {
        ...
        var transform_panel = new Akira.Layouts.Partials.TransformPanel (window);
        var border_radius_panel = new Akira.Layouts.Partials.BorderRadiusPanel (window);
        var fills_panel = new Akira.Layouts.Partials.FillsPanel (window);
        var borders_panel = new Akira.Layouts.Partials.BordersPanel (window);
        var grids_panel = new Akira.Layouts.Partials.GridsPanel (window);
        ...
        scrolled_grid.attach (grids_panel, 0, 1, 1, 1);
        scrolled_grid.attach (border_radius_panel, 0, 2, 1, 1);
        scrolled_grid.attach (fills_panel, 0, 3, 1, 1);
        scrolled_grid.attach (borders_panel, 0, 4, 1, 1);
